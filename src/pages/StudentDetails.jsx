...
export const StudentDetails = () => {
  ...
  return (
    ...
    <Heading size="md"  m="1rem">Student Details</Heading>
    <Card w="20rem" >
      ...
      <CardBody textAlign="center">
        ...
        <Button colorScheme="teal" color="white" onClick={()=>{navigate("/student/edit", {state:{_id, name, age, gender, grade, marks, attendance}})}}>Edit</Button>
        <Button onClick={() =>{ dispatch(deleteStudent(_id))}} colorScheme="red" color="white">Delete</Button>
        </ButtonGroup>
      </CardBody>
    </Card>
    </Flex>
